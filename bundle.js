...
var VideoDetail = function VideoDetail(_ref) {
  ...
  if (!video) {
    return _react.default.createElement("div", {
      ...
      className: "fa fa-cog fa-spin loading-icon"
    }), " ", _react.default.createElement("br", null), " ", _react.default.createElement("br", null), _react.default.createElement("div", null, " ", _react.default.createElement("h4", null, " Loading "), "  "));
  }

  var url = video.link;
  return _react.default.createElement("div", {
    className: "video-details col-md-6"
  }, _react.default.createElement("div", {
    id: "videoPlayer",
    className: "video-player"
  }, " "), _react.default.createElement("div", {
    className: "details"
  }, _react.default.createElement("h3", null, video.name), _react.default.createElement("hr", null), _react.default.createElement("span", null, video.description)));
};
...
var _jquery = _interopRequireDefault(__webpack_require__(28));

var _videoList = _interopRequireDefault(__webpack_require__(29));

var _videoDetail = _interopRequireDefault(__webpack_require__(14));

var _navbar = _interopRequireDefault(__webpack_require__(31));
...
function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function getVideos() {
      ...
      _jquery.default.ajax({
        ...
        error: function error(response) {
          (0, _jquery.default)('#alert').alert();
        }
      });
    }
  }, {
    key: "playVideo",
    value: function playVideo(videoId, id) {
      document.getElementById(id).scrollIntoView({
        behavior: "smooth"
      });
      var position = playlist.indexOf(videoId);
      var options = {
        id: videoId,
        width: 690,
        loop: false,
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", null, _react.default.createElement(_navbar.default, null), _react.default.createElement("div", {
        className: "app"
      }, _react.default.createElement(_videoDetail.default, {
        video: this.state.selectedVideo
      }), _react.default.createElement(_videoList.default, {
        selectedVideo: function selectedVideo(_selectedVideo) {
        ...
        id: "alert",
        role: "alert"
      }, _react.default.createElement("strong", null, "Error"), " Playlist is not reachable! Please Try again in sometime.Sorry for inconvinence.", _react.default.createElement("button", {
        type: "button",
        className: "close",
        "data-dismiss": "alert",
        "aria-label": "Close"
  ...
  return App;
}(_react.Component); // render it to dom.


_reactDom.default.render(_react.default.createElement(App, null), document.querySelector('.main'));
...
var _videoListItem = _interopRequireDefault(__webpack_require__(30));
...
var VideoList = function VideoList(props) {
  ...
  var videoItems = props.videos.map(function (video) {
    return _react.default.createElement(_videoListItem.default, {
...
var VideoListItem = function VideoListItem(_ref) {
  var video = _ref.video,
      ...
      selectedVideo = _ref.selectedVideo;
  var imageUrl = video.pictures.sizes[1].link;
  return _react.default.createElement("li", {
    className: "list-group-item",
    id: video.resource_key
  }, _react.default.createElement("div", {
    onClick: function onClick(event) {
      onVideoSelect(video.videoId, video.resource_key);
      selectedVideo(video);
    },
    ...
    src: imageUrl
  }), " \xA0 \xA0"), _react.default.createElement("div", {
    className: "media-body"
  }, _react.default.createElement("h5", {
    className: "media-heading"
  }, video.name), _react.default.createElement("i", {
    className: "fa fa-play"
  }), " ", video.stats.plays, " Plays ", _react.default.createElement("br", null), _react.default.createElement("i", {
    className: "fa fa-heart"
  }), " ", video.metadata.connections.likes.total, " Likes ", _react.default.createElement("br", null))));
};
